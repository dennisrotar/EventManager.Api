...
1. Клонируйте репозиторий:
    ```bash
    git clone <ссылка_на_ваш_репозиторий>cd EventManager
    ```
...
4. Откройте браузер и перейдите по адресу: `http://localhost:<порт>/swagger` (порт будет указан в консоли после запуска).
